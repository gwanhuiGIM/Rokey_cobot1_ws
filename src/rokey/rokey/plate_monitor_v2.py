...
# =============================================================================
# 변경 이력 (plate_monitor_v2, 실험용 수정 브랜치)
# =============================================================================
...
ROBOT_ID = "dsr01"
ROBOT_MODEL = "m0609"
NODE_NAME = "plate_position_gui_v2"
...
class PlatePositionBackend:
    ...
    def save_preset(self, name: str) -> None:
        ...
        data: Dict[str, Any] = {
            "format_version": 2,  # v2: reference_posj 추가
            "created_at": datetime.now().isoformat(),
            "robot_id": ROBOT_ID,
            "robot_model": ROBOT_MODEL,
            "gripper_model": GRIPPER_MODEL,
        ...
        for point_name, point in self.direction_points.items():
            data["direction_points"][point_name] = {
                "name": point["name"],
                "y_mm": point["y_mm"],
                "z_mm": point["z_mm"],
                "description": point["description"],
    ...
    def load_preset(self, path_str: str) -> None:
        ...
        for point_name, point in data.get("direction_points", {}).items():
            self.direction_points[point_name] = {
                "name": point["name"],
                "y_mm": point["y_mm"],
                "z_mm": point["z_mm"],
                "description": point["description"],
